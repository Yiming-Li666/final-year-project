...
# krea 训练数据集
# tr_num=30, va_num=10
def model_train(x, y, wi, language, sentence_max_length=100, tr_num=100, va_num=25):
    global model
    model = Sequential()
    ...
    score = model.evaluate(
        x[tr_num + va_num:], y[tr_num + va_num:], batch_size=40)
