...
# # print(len(data))
# # print(rate)
# wav = wavio.read("2.wav")
# print(len(wav.data))
# print(wav.rate)
# #wav.data = float(wav.data)
# #wav.data = [float(data) for data in wav.data]
# # select section of data that is noise
# noisy_part = wav.data[0:8000]
# # perform noise reduction
# reduced_noise = nr.reduce_noise(audio_clip=wav.data, noise_clip=noisy_part, verbose=True)

# #wavfile.write("./2(reduced).wav",rate,reduced_noise)
...
#================1.原始音频信号,时域信息=================================
sameple_rate,sigs = wf.read('2.wav')
...
wf.write('2(reduced).wav',sameple_rate,filter_sigs)
